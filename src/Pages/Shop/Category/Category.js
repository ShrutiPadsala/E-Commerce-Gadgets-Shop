...
export const Category = () => {
    ...
    const FetchProducts = async () => {
        const response = await axios.get(`https://fakestoreapi.in/api/products/category?type=${id}`);
        ...
        // if (id === "men-clothing") {
        //     responseCategory = "men's clothing"
        //     setMainCategory(responseCategory)
        // }
        // if (id === "women-clothing") {
        //     responseCategory = "women's clothing"
        //     setMainCategory(responseCategory)
        // }
        // if (id === "electronics") {
        //     responseCategory = "electronics"
        //     setMainCategory(responseCategory)
        // }
        // if (id === "jewelery") {
        //     responseCategory = "jewelery"
        //     setMainCategory(responseCategory)
        // }

        // const categoryProducts = products?.filter((product) => product?.category === responseCategory);
        // setfindCategory(categoryProducts);
    };
            ...
            <div className='container'>
                <div className='row mb-4'>
                    <div className='col-12'>
                        <h2 className=" product mb-0 text-uppercase">
                            {mainCategory}
                        </h2>{" "}
                    </div>
                    {
                            ...
                            return (
                                <div className='col-sm-12 col-md-3 mt-5'>
                                    <div className="card m-1 w-100">
                                        ...
                                        <Link to={`/shop/product/${product?.id}`} className="button-container">
